...
export function transpositionMatch(input, target) {
...
export function matchWords(inputWords, target) {
...
export function findMatches(wordToMatch, searchData) {
...
export function applyHighlighting(text, input) {
  let highlightedText = '';
  let inputIndex = 0;
